const AppStyles = {
  carouselContainer: "flex gap-[30px] min-h-[500px] flex-row lg:flex-nowrap justify-start lg:max-w-[1266px] m-auto relative flex-nowrap md:flex-wrap pb-2",
  ...
  itemTitle: "font-semibold text-[18px]/[30px] md:text-[22px]/[34px] text-black",
  itemDesc: "text-sm/[24px] md:text-base/[25px] text-black",
  carouselItem: `rounded-[35px] bg-white p-[20px] md:p-[20px] w-fullborder border-solid border-[1px]
 border-lightGray gap-[20px] flex flex-col min-w-[90%] flex-1 md:min-w-[290px] md:max-w-[402px] h-auto flex-1 relative 
